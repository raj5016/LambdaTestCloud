...
public class TC001_CreateLegalEntityParallel {
	...
	@Test
	public void findDriverName(String browserName,String browserVersion,String osVersion) throws MalformedURLException {
		...
		ltOptions.put("name", "EntityCreationParallel");
